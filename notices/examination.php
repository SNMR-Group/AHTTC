...
$stmt = $conn->prepare("SELECT * FROM extra_notice WHERE category = 'examination' ORDER BY created_at DESC");
$stmt->execute();
...
<head>
    ...
    <title>Examination Notices</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Examination Notices</h2>
