...
<section>
    <div id="attendance-section" class="container my-5">
        <h2 class="text-center mb-4">Teacher Attendance Records</h2>
        ...
        <?php if (!empty($attendanceData)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>No attendance records available for the teacher category.</p>
        <?php endif; ?>

    
        <div class="pagination">
            <?php if ($page > 1): ?>
                <a href="?category=<?php echo htmlspecialchars($category); ?>&page=<?php echo $page - 1; ?>" class="btn btn-secondary">Previous</a>
            <?php endif; ?>

            <?php if ($page < $total_pages): ?>
                <a href="?category=<?php echo htmlspecialchars($category); ?>&page=<?php echo $page + 1; ?>" class="btn btn-secondary">Next</a>
            <?php endif; ?>
        </div>
    </div>
</section>
