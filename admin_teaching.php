...
{
    $target_dir = "images/teacher_images/";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['add_teacher'])) {
        ...
        $sql = "INSERT INTO teachers (name, position, description, image_path) VALUES (?, ?, ?, ?)";
...
<body>
            ...
            <a style="color:white;" href="admin_notices.php">
              ...
              <a style="color:white;" href="admin_all_notices.php">
               ...
               <a style="color:white;" href="admin_teaching.php">
                <li class="d-flex align-items-center active" data-page="admin_faculty.php">
  ...
  <a style="color:white;" href="admin_ebook.php">
    ...
    <div class="container">
        ...
        <h1 class="text-center mt-5">Manage Teachers</h1>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                require 'db/db.php';
                $sql = "SELECT id, name, position, description, image_path FROM teachers";
